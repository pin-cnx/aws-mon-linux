...
security_group=`wget -q -O - http://169.254.169.254/latest/meta-data/security-groups`
...
if [ -n "$AUTOSCALE" ]; then
    CLOUDWATCH_OPTS="$CLOUDWATCH_OPTS --dimensions AutoScalingGroupName=$AUTOSCALE"
elif
